...
project = 'ddfs'
copyright = 'The ddfs authors'
author = 'The ddfs authors'
...
latex_documents = [
    (master_doc, 'ddfs.tex', 'Trio Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'ddfs', 'ddfs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ddfs', 'ddfs Documentation',
     author, 'ddfs', 'de-dup file system',
     'Miscellaneous'),
]
